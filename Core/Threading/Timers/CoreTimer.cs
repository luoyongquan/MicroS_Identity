...
namespace Core.Threading.Timers
{
    /// <summary>
    ...
    public class CoreTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public CoreTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new CoreException("Period should be set before starting the timer!");
            }
