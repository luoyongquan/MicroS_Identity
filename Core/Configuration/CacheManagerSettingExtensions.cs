...
namespace Core.Configuration
{
    ...
    public static class CacheManagerSettingExtensions
    {
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(CacheNames.ApplicationSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<int, Dictionary<string, SettingInfo>>(CacheNames.TenantSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(CacheNames.UserSettings);
        }
    }
}
