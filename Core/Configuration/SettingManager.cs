    ...
    public class SettingManager : ISettingManager, ISingletonDependency
    {
       ...
       //private readonly IMultiTenancyConfig _multiTenancyConfig;
        ...
        public async Task<IReadOnlyList<ISettingValue>> GetAllSettingValuesForApplicationAsync()
        {
            ...
            //{
            //    return (await GetReadOnlyTenantSettings(Session.GetTenantId())).Values
        ...
        public virtual async Task ChangeSettingForApplicationAsync(string name, string value)
        {
            ...
            //{
                ...
                await InsertOrUpdateOrDeleteSettingValueAsync(name, value, Session.GetTenantId(), null);
                await _tenantSettingCache.RemoveAsync(Session.GetTenantId());
            //}
        ...
        private async Task<SettingInfo> GetSettingValueForApplicationOrNullAsync(string name)
        {
            ...
            return (await GetReadOnlyTenantSettings(Session.GetTenantId())).GetOrDefault(name);
        }
